...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var tagsCornerRadius: CGFloat = 0 {
        didSet {
            for tagView in tagViews {
                tagView.cornerRadius = tagsCornerRadius
            }
        }
    }
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            tagBackgroundView.layer.shadowPath = UIBezierPath(roundedRect: tagBackgroundView.bounds, cornerRadius: tagsCornerRadius).cgPath
